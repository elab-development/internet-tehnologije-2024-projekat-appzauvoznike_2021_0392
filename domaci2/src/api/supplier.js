...
export const searchMyProducts = (params) =>
  api.get("/supplier/products-search", { params });
export const createProduct = (payload) => api.post("/supplier/products", payload);
export const getMyProduct = (id) => api.get(`/supplier/products/${id}`);
...
export const getOffer = (id) => api.get(`/supplier/offers/${id}`);          // <—
...
/* ============== OFFER ITEMS ============== */
export const addOfferItem = (offerId, payload) =>
  api.post(`/supplier/offers/${offerId}/items`, payload);
